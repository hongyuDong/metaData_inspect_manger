...
public class DBUtil {
     ...
     * @throws SQLException
     */
    public static List<LinkedHashMap<String, Object>> query(String sql) throws SQLException {
     ...
     * @throws SQLException
     */
    public static List<LinkedHashMap<String, Object>> query(String tableName, Map<String, Object> whereMap) throws SQLException {
        String whereClause = "";
     ...
     * @throws SQLException
     */
    public static List<LinkedHashMap<String, Object>> query(String tableName, String whereClause, String[] whereArgs) throws SQLException {
        return query(tableName, false, null, whereClause, whereArgs, null, null, null, null);
    }
     ...
     * @throws SQLException
     */
    public static List<LinkedHashMap<String, Object>> query(String tableName, boolean distinct, String[] columns, String selection, Object[] selectionArgs, String groupBy, String having, String orderBy, String limit) throws SQLException {
     ...
     * @throws SQLException SQL执行异常
     */
    public static List<LinkedHashMap<String, Object>> executeQuery(String sql, Object[] bindArgs) throws SQLException {
     ...
     * @throws SQLException
     */
    private static List<LinkedHashMap<String, Object>> getDatas(ResultSet resultSet) throws SQLException {
        List<LinkedHashMap<String, Object>> datas = new ArrayList<>();
        /**获取结果集的数据结构对象**/
